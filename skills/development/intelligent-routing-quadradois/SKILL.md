...
| **Real Estate** | imóvel, apartamento, casa, corretor, locação, venda, aluguel, visita, captação, proposta, proprietário, comprador, locatário, financiamento, FGTS | Load skills: `real-estate-qualification`, `property-matching`, `visit-scheduling`, `negotiation-assistant`, `property-capture` |
