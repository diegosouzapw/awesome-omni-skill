...
### With CURSOR.mdc Rules

- **Priority**: CURSOR.mdc rules > intelligent-routing
- If CURSOR.mdc specifies explicit routing, follow it
...
**Next Steps**: Integrate this skill into CURSOR.mdc TIER 0 rules.
