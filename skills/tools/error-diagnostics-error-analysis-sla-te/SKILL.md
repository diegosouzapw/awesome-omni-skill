...
- Use when: the user asks to run the `error-analysis` workflow and the task requires multi-step orchestration.
...
- Converted from `~/code/agents/plugins/error-diagnostics/commands/error-analysis.md`
