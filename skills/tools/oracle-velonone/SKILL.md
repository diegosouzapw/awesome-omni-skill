...
homepage: https://github.com/Vleonone/aeonsage
metadata: {"aeonsage":{"emoji":"🧿","requires":{"bins":["oracle"]},"install":[{"id":"node","kind":"node","package":"@aeonsage/oracle","bins":["oracle"],"label":"Install oracle (node)"}]}}
---
...
- Help:
  - `oracle --help`
  - If the binary isn’t installed: `npx -y @Vleonone/oracle --help` (avoid `pnpx` here; sqlite bindings).
