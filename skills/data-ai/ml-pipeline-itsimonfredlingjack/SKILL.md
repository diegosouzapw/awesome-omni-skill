---
name: ml-pipeline
description: Design and implement a complete ML pipeline for: (use the user's prompt)
---
...
prompt: |
  Analyze and design data pipeline for ML system with requirements: (use the user's prompt)
...
prompt: |
  Design feature engineering and model requirements for: (use the user's prompt)
